...
import { camelize, getCurrentInstance, h, isVNode, mergeProps, nextTick, onBeforeUnmount, render } from 'vue';
import type { ComponentExposed, ComponentProps } from 'vue-component-type-helpers';
import { CHILD_REF, CONFIG_KEY, CONTAINER, INSTALLED_KEY, NATIVE_PROPS } from './config';
import type { CreateComponent, CustomApp, CustomComponent, CustomVNode, Option, VNodeChildren } from './types';
...
export function create<T extends Component>(component: T, conf?: ComponentInternalInstance | Option | null, ins?: ComponentInternalInstance): CreateComponent<T> {
    ...
    const instance = isInstance(conf) ? conf : ins;
    (component as CreateComponent<T>).$create = (props?: ComponentProps<T> | null, children?: VNodeChildren, _conf?: Option) =>
    ...
    if (instance) {
        ...
        // 为全局属性暴露补充声明
        instance.appContext.config.globalProperties[camelize(`$create-${component.name}`)] = function insetCreate(this: ComponentInternalInstance | void, props?: ComponentProps<T> | null, children?: VNodeChildren, config?: Option) {
...
export function useComponent<T extends Component>(comp: T, conf?: Option | ComponentInternalInstance | null, ins?: ComponentInternalInstance | null) {
    ...
    return (props?: ComponentProps<T> | null, children?: VNodeChildren) => {
        ...
        /** 更新 props */
        function updateProps(props: Record<string, any> | undefined | null, mergeProps?: boolean) {
            if (!mountComponent[KEY]) return;
            mountComponent[KEY][NATIVE_PROPS] = mergeProps ? { ...mountComponent[KEY][NATIVE_PROPS], ...props } : props;
        }
